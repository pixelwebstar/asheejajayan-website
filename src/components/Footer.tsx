  ...
  return (
    <footer id="contact" className="bg-surface-2 border-t border-border pt-12 lg:pt-20 pb-6 lg:pb-10">
      <div className="mx-auto w-full max-w-none px-6 sm:px-12 lg:px-20 xl:px-28">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 md:gap-6 mb-12 lg:mb-16">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-6 text-center lg:text-left">
            ...
            <p className="text-muted font-medium leading-relaxed text-sm max-w-md mx-auto lg:mx-0">
