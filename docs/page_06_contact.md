...
*   **Hero Actions:**
    *   **Primary Button:** "Go to Intake Form" (smooth-scrolls to Section 2: Form).
...
└───────────────────────────────┬─────────────────────────────────┘
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│ Section 2: Comprehensive Intake Form (bg-cool-light)            │
│ Goals: Gather structured info (Timeline, Budget, Plan, Scope)   │
└───────────────────────────────┬─────────────────────────────────┘
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│ Section 3: Contact Channels (bg-warm-light)                     │
...
*   **CTA Button:** Yes ("Go to Intake Form" $\rightarrow$ `#message` / "Direct Channels" $\rightarrow$ `#channels`).

### Section 2: Comprehensive Intake Form
...
*   **Background:** Warm Sand (`bg-warm-light`)
*   **Goal:** Provide alternative ways to reach you for users who dislike form fields (e.g. Robert the Plumber who prefers to call).
